...
func parseEvent(pageStr string, left int) (EventString, int) {
	...
	ev.Beatmapset.Hype, left = findWithIndex(pageStr, "\"hype\":", ",", left)
	ev.Beatmapset.Id, left = findWithIndex(pageStr, "\"id\":", ",", left)
	ev.Beatmapset.Nsfw, left = findWithIndex(pageStr, "\"nsfw\":", ",", left)
	ev.Beatmapset.PreviewUrl, left = findWithIndex(pageStr, "preview_url : ", " ,", left)
	ev.Beatmapset.PreviewUrl = strings.ReplaceAll(ev.Beatmapset.PreviewUrl, "\\", "")
	ev.Beatmapset.Source, left = findWithIndex(pageStr, "source : ", " , spotlight", left)
	ev.Beatmapset.Spotlight, left = findWithIndex(pageStr, "spotlight :", ",", left)
	ev.Beatmapset.Status, left = findWithIndex(pageStr, "status : ", " ,", left)
	ev.Beatmapset.Title, left = findWithIndex(pageStr, "title : ", " , title_", left)
	ev.Beatmapset.TitleUnicode, left = findWithIndex(pageStr, "title_unicode : ", " , track_", left)
