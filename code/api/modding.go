...
func parseEvent(pageStr string, left int) (EventString, int) {
	...
	ev.Beatmapset.Hype, left = findWithIndex(pageStr, "\"hype\":", ",\"id", left)
	ev.Beatmapset.Id, left = findWithIndex(pageStr, "\"id\":", ",", left)
	ev.Beatmapset.Nsfw, left = findWithIndex(pageStr, "\"nsfw\":", ",", left)
	ev.Beatmapset.Offset, left = findWithIndex(pageStr, "\"offset\":", ",", left)
	ev.Beatmapset.PlayCount, left = findWithIndex(pageStr, "\"play_count\":", ",", left)
	ev.Beatmapset.PreviewUrl, left = findStringWithIndex(pageStr, "\"preview_url\":", ",", left)
	ev.Beatmapset.PreviewUrl = strings.ReplaceAll(ev.Beatmapset.PreviewUrl, "\\", "")
	ev.Beatmapset.Source, left = findWithIndex(pageStr, "\"source\":", ",", left)
	ev.Beatmapset.Spotlight, left = findWithIndex(pageStr, "\"spotlight\":", ",", left)
	ev.Beatmapset.Status, left = findStringWithIndex(pageStr, "\"status\":", ",", left)
	ev.Beatmapset.Title, left = findStringWithIndex(pageStr, "\"title\":", ",", left)
	ev.Beatmapset.TitleUnicode, left = findStringWithIndex(pageStr, "\"title_unicode\":", ",", left)
	ev.Beatmapset.TrackId, left = findWithIndex(pageStr, "\"track_id\":", ",", left)
	...
	ev.Discussion.Timestamp, left = findWithIndex(pageStr, "\"timestamp\":", ",", left)
	...
	ev.Discussion.StartingPost.Message, left = findStringWithIndex(pageStr, "\"message\":", ",\"system\":", left)
