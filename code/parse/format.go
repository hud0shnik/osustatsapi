...
func parseScore(s ScoreString) Score {
	return Score{
		...
		Statistics: Statistics{
			Great: ToInt(s.Statistics.Great),
			Meh:   ToInt(s.Statistics.Meh),
			Ok:    ToInt(s.Statistics.Ok),
			Miss:  ToInt(s.Statistics.Miss),
		},
		TotalScore:            ToInt(s.TotalScore),
		UserId:                ToInt(s.UserId),
		...
		BeatMap: BeatMap{
			BeatMapSetId:     ToInt(s.BeatMap.BeatMapSetId),
			DifficultyRating: ToFloat64(s.BeatMap.DifficultyRating),
			Id:               ToInt(s.BeatMap.Id),
			Mode:             s.BeatMap.Mode,
			Status:           s.BeatMap.Status,
			TotalLength:      ToInt(s.BeatMap.TotalLength),
			UserId:           ToInt(s.BeatMap.UserId),
			Version:          s.BeatMap.Version,
			Accuracy:         ToFloat64(s.BeatMap.Accuracy),
			Ar:               ToFloat64(s.BeatMap.Ar),
			Bpm:              ToFloat64(s.BeatMap.Bpm),
			Convert:          ToBool(s.BeatMap.Convert),
			CountCircles:     ToInt(s.BeatMap.CountCircles),
			CountSliders:     ToInt(s.BeatMap.CountSliders),
			CountSpinners:    ToInt(s.BeatMap.CountSpinners),
			Cs:               ToFloat64(s.BeatMap.Cs),
			DeletedAt:        s.BeatMap.DeletedAt,
			Drain:            ToFloat64(s.BeatMap.Drain),
			HitLength:        ToInt(s.BeatMap.HitLength),
			IsScoreable:      ToBool(s.BeatMap.IsScoreable),
			LastUpdated:      s.BeatMap.LastUpdated,
			ModeInt:          ToInt(s.BeatMap.ModeInt),
			PassCount:        ToInt(s.BeatMap.PassCount),
			PlayCount:        ToInt(s.BeatMapSet.PlayCount),
			Ranked:           ToInt(s.BeatMap.Ranked),
			Url:              s.BeatMap.Url,
